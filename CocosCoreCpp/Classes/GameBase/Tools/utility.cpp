...
namespace utility
{
	...
	void runPaoMaDeng(cocos2d::Node* pTxtNode,cocos2d::Node* pLayoutNode,std::string kTxt,cocos2d::FiniteTimeAction* pNetAction)
	{
		cocos2d::Node* pTxt = pTxtNode;
		((cocos2d::Label*)pTxt)->setString(kTxt);		
